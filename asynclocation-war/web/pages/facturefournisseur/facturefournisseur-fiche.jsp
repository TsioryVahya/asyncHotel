...
<div class="content-wrapper">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <% if (f.getEtat() >= 11) { %>
                                ...
                                <a class="btn btn-secondary pull-right"  href="<%= lien + "?but="+ "caisse/mvt/mvtCaisse-saisie-sortie-fc.jsp" +"&idOrigine=" + id+"&devise="+f.getIdDevise()+"&montant="+f.getMontantreste()+"&tiers="+f.getIdFournisseur()+"&idPrevision="+f.getIdPrevision()%>" style="margin-right: 10px">Decaisser</a>
    ...
    <div class="row m-0">
        ...
        <div class="col-md-12 bottom-vente-fiche">
            <div class="box">
                <h5 class="h520pxSemibold" style="margin-left: 10px;">Les fichiers attach&eacute;s</h5>
