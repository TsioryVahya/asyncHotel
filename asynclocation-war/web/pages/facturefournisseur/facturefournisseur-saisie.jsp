...
<%
    try {
        ...
        affichage.Champ.setPageAppelComplete(pi.getFormufle().getChampFille("idProduit"),"produits.IngredientsLib","id","ST_INGREDIENTSAUTO","pu;compte_achat","pu;compte");
        ...
        pi.getFormufle().getChamp("idProduit_0").setLibelle("Composant");
        ...
        String[] colOrdre = {"id","idProduit","compte","qte","pu","tva","idDevise","tauxDeChange","kilometrage","idvoiture"};
...
<div class="content-wrapper">
    <h1 class="box-title">Nouvelle facture fournisseur</h1>
   <div class="row">
        <div class="col-md-12">
            <div class="box-fiche">
                <div class="">
