                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a class="btn btn-primary pull-right" href="<%= lien + "?but=apresTarif.jsp&acte=valider&id=" + id + "&bute=reservation/reservation-fiche.jsp&idresa="+t.getIdReservationMere()+"&classe="+classe+"&nomtable=checkIn&tab=inc/liste-checkin"%> " style="margin-right: 10px" onsubmit="closeModal()">Viser</a>
                            <a class="btn btn-secondary pull-right"  href="<%= lien + "?but="+ pageModif +"&id=" + id%>" style="margin-right: 10px">Modifier</a>
                            <a class="btn btn-danger pull-left" href="<%= lien + "?but=apresTarif.jsp&id=" + id+"&acte=annuler&bute=check/checkin-fiche.jsp&classe="+classe %>" style="margin-right: 10px" >Annuler</a>
                            <a class="btn btn-secondary pull-right" href="<%= lien + "?but=vente/vente-saisie.jsp&id=" + id %> " style="margin-right: 10px">Facturer</a>
                        </div>
