                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a class="btn btn-danger pull-left" href="<%= lien + "?but=apresTarif.jsp&id=" + id+"&acte=annuler&bute=check/checkin-fiche.jsp&classe="+classe %>" style="margin-right: 10px !important">Annuler</a>
                            <a class="btn btn-secondary pull-left"  href="<%= lien + "?but="+ pageModif +"&id=" + id%>" style="margin-right: 10px">Modifier</a>
                            <a class="btn btn-primary pull-right" href="<%= lien + "?but=apresTarif.jsp&acte=valider&id=" + id + "&bute=reservation/reservation-fiche.jsp&classe="+classe+"&nomtable=checkout&tab=inc/liste-checkout&idresa="+t.getIdReservationMere()%> " style="margin-right: 10px" onsubmit="closeModal()">Viser</a>
                            <a class="btn btn-primary pull-right" href="<%= lien + "?but=vente/vente-saisie.jsp&id=" + id %> " style="margin-right: 10px">Facturer</a>
                        </div>
