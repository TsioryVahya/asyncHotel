...
<div class="content-wrapper">
        ...
        <div class="col-md-12 mb-5">
            <div class="box-fiche">
                ...
                <div class="box-footer">
                        ...
                        <a class="btn btn-secondary pull-left"  href="<%=(String) session.getValue("lien") + "?but=pertegain/pertegainimprevue-modif.jsp&id=" + id%>"  style="margin-right: 10px">Modifier</a>

                   
                    
                         <% if(pertegainimprevue.getGain()>0){%>
                            <a class="btn btn-tertiary pull-right"  href="<%=(String) session.getValue("lien") + "?but=pertegain/pertegain-mvtcaisse-saisie.jsp&id=" + id+"&perteougain=1&montant="+pertegainimprevue.getMontantttc()%>"  style="margin-right: 10px">Entre caisse</a>
                        <%} else if(pertegainimprevue.getPerte()>0){%>
                                <a class="btn btn-tertiary pull-right"  href="<%=(String) session.getValue("lien") + "?but=pertegain/pertegain-mvtcaisse-saisie.jsp&id=" + id+"&perteougain=-1&montant="+pertegainimprevue.getMontantttc()%>"  style="margin-right: 10px">sortie caisse</a>
                            <% } %>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="h329pxBold" style="margin-left: 10px;">Les fichiers attach&eacute;s</h3>
            <div class="box-fiche">
                <div class="box">
                    <div class="box-body">
