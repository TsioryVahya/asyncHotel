...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        <h1 class="h520pxSemibold">Modifier Plan de Paiement</h1>
    </div>
    <div class="row">
                    ...
                    <form  id="incident" class="incident-pp-fiche" onsubmit='modifEtatMult(event)' enctype="multipart/form-data">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-bordered table-modif-pp">
                                <thead>
                                <tr>
                                    <th class="contenuetable" style="background-color:#bed1dd">
                                        <input onclick="CocheToutCheckbox(this, 'ids')" type="checkbox">
                                    </th>
                                    <th class="contenuetable">D&eacute;signation</th>
                                    <th class="contenuetable">Caisse</th>
                                    <th class="contenuetable">Debit</th>
                                    <th class="contenuetable">Credit</th>
                                    <th class="contenuetable">Date</th>
                                    <th class="contenuetable">Devise</th>
                                    <th class="contenuetable">Taux</th>
                                </tr>
                                </thead>
                        ...
                        <div class="col-md-12 pp-fiche-btn" style="margin-top: 2rem;" align="right">
                            ...
                            <% } %>
                            <button type="submit" name="acte" value="modifier_prevision" class="btn btn-secondary pull-right" style="margin-right: 10px;" onclick="document.getElementById('acte').value='scinder_prevision'" >Scinder</button>
                            <button type="submit" name="acte" value="modifier_prevision" class="btn btn-secondary pull-right" style="margin-right: 10px;" onclick="document.getElementById('acte').value='modifier_prevision'" >Modifier</button>
                            <button type="submit" name="acte" value="supprimer_prevision" class="btn btn-danger pull-left" style="margin-right: 10px;" onclick="document.getElementById('acte').value='supprimer_prevision'" >Supprimer</button>
