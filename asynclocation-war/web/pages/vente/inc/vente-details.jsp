...
<div class="box-body">
    <%
        String libEnteteAffiche[] =  {"id", "D&eacute;signation","Quantit&eacute;","Prix Unitaire","Prix de revient","Devise","Taux","TVA(en %)","remise (en %)","montant","montant revient","marge brute"};
