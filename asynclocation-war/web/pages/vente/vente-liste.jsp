...
<% try{
    ...
    String listeCrt[] = {"id", "designation","idClientLib","montantttc","daty"};
    String listeInt[] = {"daty","montantttc"};
    ...
    String libEnteteAffiche[] = {"id", "D&eacute;signation","Client","devise","Date","Montant TTC","montant Revient","marge Brute","Montant Pay&eacute;","Montant Restant","&Eacute;tat"};
    ...
    String[] colSommeLib = { "Montant TTC", "Montant Pay&eacute;", "Montant Restant","marge Brute" };
    ...
    //pr.getTableauRecap().setLibelleAffiche(colSommeLib);
%>
<script>
