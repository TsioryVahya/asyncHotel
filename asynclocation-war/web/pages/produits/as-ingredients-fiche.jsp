...
<div class="content-wrapper">
    <h1 class="box-title">  <a href="<%=(String) session.getValue("lien")%>?but=produits/as-ingredients-liste.jsp"><i class="fa fa-angle-left"></i></a><%=pc.getTitre()%></h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a class="btn btn-secondary pull-right"  href="<%=(String) session.getValue("lien") + "?but=produits/as-ingredients-modif.jsp&id=" + request.getParameter("id")%>" style="margin-right: 10px">Modifier</a>
                            ...
                            <%  if(isDispo.equals("DISPONIBLE")) { %> <a class="btn btn-danger pull-left"  href="<%=(String) session.getValue("lien") + "?but=apresTarif.jsp&acte=disponible&isdispo=false&id=" + request.getParameter("id")%>" style="margin-right: 10px">Indisponible</a><%}%>
                         </div>
                    </div>
