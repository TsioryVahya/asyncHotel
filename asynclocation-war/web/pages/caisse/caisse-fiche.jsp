                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <% if(caisse.getEtat() > 0) { %>
                              <a  class="btn btn-danger pull-left"  href="<%= lien + "?but=apresTarif.jsp&id=" + id+"&acte=annuler&bute=caisse/caisse-fiche.jsp&classe="+classe %>">Annuler</button></a>
                            ...
                            <% if(caisse.getEtat()== 11) { %>
                                <a style="margin-right: 10px" class="btn btn-secondary pull-right" href="<%= (String) session.getValue("lien") + "?but=apresTarif.jsp&acte=annulerVisa&id=" + request.getParameter("id") + "&bute=caisse/caisse-fiche.jsp&classe=" + classe %>">Annuler Visa</a>
                            <% } %>
                        </div>
