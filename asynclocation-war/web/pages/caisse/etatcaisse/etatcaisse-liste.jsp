...
<% try{
    ...
    liste[0] = new Liste("idPointLib",new Point(),"val","val");
    liste[1] = new Liste("idTypeCaisselib",new TypeCaisse(),"val","val");
...
/*    String lienTableau[] = {pr.getLien() + "?but=fiche/template-fiche-simple.jsp"};
    ...
    String libEnteteAffiche[] = {"Caisse","Point","Type de Caisse","date Dernier Report","Solde Initiale","Entr&eacute;e","D&eacute;pense", "Solde Finale"};
